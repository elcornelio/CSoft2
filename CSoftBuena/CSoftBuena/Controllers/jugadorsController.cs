...
namespace CSoftBuena.Controllers
{
    public class jugadorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,dni,nombre,apellido1,apellido2,telefono,direccion,ciudad,provincia,pais,email,idTorneo,idUsuario")] jugador jugador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,dni,nombre,apellido1,apellido2,telefono,direccion,ciudad,provincia,pais,email,idTorneo,idUsuario")] jugador jugador)
        {
            if (ModelState.IsValid)
            {
